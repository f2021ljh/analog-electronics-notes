...
![[diode-symbol.png| 200]]
不同类型的二极管如下图所示。
![[diode-types.png]]
## 二极管的直流特性
二极管的伏安特性曲线近似为 PN 结的伏安特性曲线如下图。
![[diode-voltage-current.png| 450]]
### 正向特性
...
![[diode-temperature-effect.png| 350]]
...
- 若施加正向电压，则为导通状态，视为短路；
- 若施加反向电压，则为截止状态，视为开路。
![[diode-ideal-model.png| 400]]
#### 应用：限幅电路
![[amplitude-limiting-circuit.png| 300]] ![[amplitude-limiting-circuit-diagram.png| 350]]
该模型主要用于信号幅值远大于二极管的正向压降，可忽略二极管正向压降和反向电流的电路中。
#### 应用：单相半波整流电路
![[half-wave-rectifier-circuit.png| 350]] ![[half-wave-rectifier-circuit-diagram.png| 300]]
当 $u_2$ 处于正半周时，二极管导通；当 $u_2$ 处于负半周时，二极管截止。
### 二极管的恒压降模型
如图，若二极管正向电压超过正向导通电压，则视为并联恒压源，支路电压恒定。
![[constant-voltage-drop-model.png| 450]]
### \*二极管的折线近似模型
如图，若正向电压超过开启电压（死区电压），则视为恒压源 $U _{\mathrm{TH}}$ 与电阻 $r _{\mathrm{D}}=\dfrac{u _{\mathrm{D}}-U _{\mathrm{TH}}}{i _{\mathrm{D}}}$ 串联。
![[broken-line-approximation-model.png| 530]]
### 二极管的小信号模型
